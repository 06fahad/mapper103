 ...
 */
void drawtextleft(float xc, float yc, const std::string& text, float boundx=FLT_MAX, float boundy=FLT_MAX);
// using screen pixel width, text ratio is 2:1.45~1.50 height:width
